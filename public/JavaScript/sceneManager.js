...
export class SceneManager {
    ...
    drawInit() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.field.loadImage("mount01");
            yield this.field.loadImage("map01");
            yield this.field.loadImage("cave01");
            yield this.field.loadImage("field01");
            yield this.field.loadImage("boss");
            yield this.field.loadImage("heal");
            console.log("IMAGE LOAD END");
        });
    }
    //シーンの変更 バトルからフィールド（フィールド、洞窟）に移動、またはその逆。
    changeScene(new_scene_name) {
